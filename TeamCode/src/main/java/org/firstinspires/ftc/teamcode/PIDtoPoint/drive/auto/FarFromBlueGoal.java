...
@Autonomous(name="Far From Blue Goal", group="Auto")
//@Disabled

public class FarFromBlueGoal extends LinearOpMode {
    ...
    static final Pose2D SHOOT_POSE = new Pose2D(DistanceUnit.INCH, 8, 0, AngleUnit.DEGREES, 0);
